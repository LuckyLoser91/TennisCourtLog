...
def update_gs_matches(years, tour):
    ...
    # 先删除指定年份的数据
    gs_matches = gs_matches[~gs_matches['year'].isin(years)]
    for year in years:
...
if __name__ == '__main__':
    update_gs_matches(years=range(2026, 2027), tour='wta')
    update_gs_matches(years=range(2026, 2027), tour='atp')
    # need first to update tennis-tour文件下的live-rank，来源是tennisabstract
