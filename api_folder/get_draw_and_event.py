...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-dir', type=str, default='api_folder/data/wimbledon_2026',
                        help='数据保存目录 (默认: api_folder/data/wimbledon_2026)')
    parser.add_argument('--tournament-id', type=int, default=2600,
                        help='赛事ID (默认: 2600 for Roland Garros)')
    parser.add_argument('--season-id', type=int, default=85945,
                        help='赛季ID (默认: 85945 for 2026)')
    ...
    # 第三步： 抓取已完成比赛的 statistics 和 detail
